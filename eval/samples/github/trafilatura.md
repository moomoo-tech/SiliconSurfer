...
# [dependencies]
# rustc-serialize = "*"
You can then compile this using Cargo build and run it using Cargo run. After it's running you should visit [http://localhost:6767](http://localhost:6767) to see your hello world!
More examples can be found [in the examples directory](/nickel-org/nickel.rs/blob/master/examples) and the full documentation can be [found here](https://docs.rs/nickel/).
[nickel.rs](http://nickel-org.github.io) is a community effort. We welcome new contributors with open arms. Please read the [contributing guide here](/nickel-org/nickel.rs/blob/master/contributing.md) first.
