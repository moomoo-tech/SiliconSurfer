...
[What is “AI”, Really?](#what-is-ai-really)
...
still images, or link multiple kinds of models together.[1](#fn-1)
...
alive.[2](#fn-2) Humans are, [it turns
...
[Unreliable Narrators](#unreliable-narrators)
...
This is silly. LLMs have no special metacognitive capacity.[3](#fn-3)
...
[Models are Smart](#models-are-smart)
...
[Models are Idiots](#models-are-idiots)
At the same time, ML models are idiots.[4](#fn-4) I occasionally pick up a frontier
...
the post. After a while, we compromised on me being bisexual.[5](#fn-5)
...
the graph data was randomly generated.[6](#fn-6) Just this afternoon, a friend
...
because they can’t do basic math.[7](#fn-7) Google’s “AI” summaries are
...
[The Jagged Edge](#the-jagged-edge)
...
[Improving, or Maybe Not](#improving-or-maybe-not)
